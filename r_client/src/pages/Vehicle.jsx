          ...
          <div key={index}>
            ...
            <details>
              ...
              <ul>
                ...
                <li>
                  Battery charging time = {item.Battery_charging_time} Hrs
                </li>
            ...
            <details>
              ...
              <ul>
                ...
                <li>
                  Carrying capacity: {item.Carrying_capacity.toLocaleString()}{" "}
                  kg
                </li>
              </ul>
            </details>
            <details>
              ...
              <ul>
                ...
                <li>
                  Overall Height: {item.Overall_Height.toLocaleString()} mm
                </li>
                <li>Kerb Weight: {item.Kerb_Weight.toLocaleString()} kg</li>
              </ul>
            </details>
            ...
            <div style={{ textAlign: "center" }}>
              <a href={item.company_link}>
                <button className="buynow" style={{ marginBottom: "50px" }}>
                  Buy Now
                </button>
              </a>
            </div>
